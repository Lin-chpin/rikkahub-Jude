...
interface MemoryDAO {
    ...
    @Query("SELECT * FROM memoryentity WHERE id = :id AND assistant_id = :scopeId")
    suspend fun getMemoryByIdInScope(id: Int, scopeId: String): MemoryEntity?
    ...
    suspend fun deleteMemoryInScope(id: Int, scopeId: String): Int
